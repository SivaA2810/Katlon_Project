...
public class Utility {
	...
	public  String[][] getValuefromExcel() throws Exception {
		XSSFWorkbook book = new XSSFWorkbook("C:\\Users\\HP\\Eclipse workspace new\\Katlon_Project\\File\\testData.xlsx");
	...
	String path = "C:\\Users\\HP\\Eclipse workspace new\\Katlon_Project\\Screenshots\\"+sreenshotname+".png";
